...
- **Added: a "Disc N" separator in the tracklist for multi-disc albums**,
  so it's clear when the list moves from one disc to the next instead of
  just jumping straight to track 1 again with no explanation.
