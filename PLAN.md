...
(none open — everything recently shipped is fully documented in [CHANGELOG.md](CHANGELOG.md) (user-facing) and `CLAUDE.md` (full technical narrative, dated sections))
