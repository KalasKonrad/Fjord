...
- [ ] **#38 — Investigate massive frame drops with vsync=audio (intermittent)** *(under investigation)* — sporadic large spike in dropped frames, recovered by switching vsync mode. Likely mpv audio clock drift or Wayland frame timing issue. Not reproduced since the issue was filed — may be resolved. Keep watching; capture stats if it recurs.
