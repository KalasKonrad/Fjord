...
//   ROW_* constants      named indices for settings rows (0–15)
...
const ROW_VF:                      i32 = 4;
const ROW_DEINTERLACE:             i32 = 5;
const ROW_VIDEO_BEHIND:            i32 = 6;
const ROW_VIDEO_SYNC:              i32 = 7;
const ROW_INTERPOLATION:           i32 = 8;
const ROW_TSCALE:                  i32 = 9;
const ROW_TONE_MAPPING:            i32 = 10;
const ROW_TARGET_COLORSPACE:       i32 = 11;
const ROW_OPENGL_EARLY_FLUSH:      i32 = 12;
const ROW_VIDEO_LATENCY_HACKS:     i32 = 13;
const ROW_CACHE_MB:                i32 = 14;
pub(crate) const ROW_SIGN_OUT:     i32 = 15;
